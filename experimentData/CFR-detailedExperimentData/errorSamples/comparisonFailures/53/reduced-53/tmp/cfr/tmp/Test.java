...
public class Test {
    ...
    public void mainTest(String[] stringArray) {
        ...
        System.out.println("l i i11 = " + l + "," + n + "," + n2);
        System.out.println("i12 f1 i13 = " + n3 + "," + Float.floatToIntBits(f) + "," + n4);
        System.out.println("i14 i15 i16 = " + n5 + "," + n6 + "," + n7);
        System.out.println("byArr1 = " + Test.checkSum(byArray));
        System.out.println("Test.instanceCount Test.sFld Test.byFld = " + instanceCount + "," + sFld + "," + byFld);
