// Generated by Java* Fuzzer test generator (1.0.001). Thu Jan  6 00:39:08 2022
public class Test {
    ...
    public static long lMeth() {
        ...
        long meth_res = i10 + i11 + i12 + i13 + i14 + i15 + FuzzerUtils.checkSum(iArr);
    ...
    public static float fMeth(int i6, int i7, int i8) {
        ...
        long meth_res = i6 + i7 + i8 + Double.doubleToLongBits(d) + i9 + FuzzerUtils.checkSum(bArr) +
    ...
    public void mainTest(String[] strArr1) {
        ...
        int i=13484, i1=42196, i2=31897, i3=-1, i4=233, i16=220, i17=-5, i18=-16230, i19=171, i20=-35848, i21=-9525,
            i22=-207;
        float f=-62.976F, fArr[]=new float[N];
        short s=-21624;
        double dArr[][][]=new double[N][N][N];

        FuzzerUtils.init(fArr, 98.624F);
        FuzzerUtils.init(dArr, -60.73362);
        ...
        while (++i < 298) {
            for (i1 = 3; i1 < 84; i1++) {
                for (i3 = 1; i3 < 2; ++i3) {
                    fArr[i1] *= i3;
                    i2 = (int)(((Test.instanceCount - Test.instanceCount) + (-48916 - Math.abs(Test.instanceCount))) ^
                        (long)(-(-40.112526 * (Test.instanceCount + 2.18F))));
                }
                ...
                case 33:
                    for (i21 = 1; i21 < 2; i21++) {
                        ...
                        case 16:
                            ...
                            break;
                        case 34:
                            Test.byFld += (byte)(((i21 * i16) + i3) - Test.fFld);
                        case 35:
                            Test.fFld = Test.instanceCount;
                            break;
                        case 24:
        ...
        FuzzerUtils.out.println("i16 s i17 = " + i16 + "," + s + "," + i17);
