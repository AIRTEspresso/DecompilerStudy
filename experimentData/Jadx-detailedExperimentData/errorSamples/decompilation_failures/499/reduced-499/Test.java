...
public class Test {
    ...
    public static float fMeth(int i6, int i7, int i8) {
        ...
        long meth_res = i6 + i7 + i8 + Double.doubleToLongBits(d) + i9 + checkSum(bArr) +
            checkSum(lArr);
    ...
    public void mainTest(String[] strArr1) {
        ...
        System.out.println("i21 i22 fArr = " + i21 + "," + i22 + "," +
            Double.doubleToLongBits(checkSum(fArr)));
        System.out.println("dArr = " + Double.doubleToLongBits(checkSum(dArr)));

        System.out.println("Test.instanceCount Test.fFld Test.bFld = " + Test.instanceCount + "," +
