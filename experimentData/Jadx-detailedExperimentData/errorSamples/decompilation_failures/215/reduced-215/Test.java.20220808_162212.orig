...
public class Test {
    ...
    static {
        init(Test.dArrFld, 93.1927);
        init(Test.byArrFld, (byte)-56);
    ...
    public void mainTest(String[] strArr1) {
        ...
        System.out.println("i5 i17 i18 = " + i5 + "," + i17 + "," + i18);
        System.out.println("b3 s = " + (b3 ? 1 : 0) + "," + s);

        System.out.println("Test.instanceCount iFld Test.dFld = " + Test.instanceCount + "," + iFld + "," +
            Double.doubleToLongBits(Test.dFld));
        System.out.println("Test.byFld Test.fFld Test.dArrFld = " + Test.byFld + "," +
            Float.floatToIntBits(Test.fFld) + "," + Double.doubleToLongBits(checkSum(Test.dArrFld)));
        System.out.println("Test.byArrFld iArrFld lArrFld = " + checkSum(Test.byArrFld) + "," +
            checkSum(iArrFld) + "," + checkSum(lArrFld));
