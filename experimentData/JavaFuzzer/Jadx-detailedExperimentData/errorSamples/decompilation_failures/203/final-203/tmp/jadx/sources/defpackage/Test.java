...
/* renamed from: Test */
/* loaded from: /root/DecompilerTester/testhome-save-jadx-2022.8.9/error_ones/203/final-203/tmp/Test.dex */
class Test {
    int N = 400;
    long instanceCount;
    ...
    void vMeth1(int i, long j, int i2) {
        int i3 = this.N;
        init((boolean[][][]) Array.newInstance(boolean.class, i3, i3, i3), true);
    }
