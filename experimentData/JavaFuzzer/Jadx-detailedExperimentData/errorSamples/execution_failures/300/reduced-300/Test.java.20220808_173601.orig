...
public class Test {
    ...
    static {
        init(Test.dArrFld, 2.33381);
        init(Test.iArrFld, -19555);
    }
    ...
    public static void vMeth1(byte by, long l, int i4) {
        ...
        vMeth1_check_sum += by + l + i4 + i5 + i6 + Float.floatToIntBits(f) + s + i8 + i9 + checkSum(lArr)
            + checkSum(iArr) + checkSum(bArr);
    }
    ...
    public static void vMeth(int i2, int i3) {
        ...
        vMeth_check_sum += i2 + i3 + by2 + i11 + i12 + i13 + l2 + i14 + checkSum(lArr1);
    }
    ...
    public void mainTest(String[] strArr1) {
                ...
                case 78:
                    for (i16 = i; i16 < 69; i16++) {
                        ...
                        do {
                            ...
                            i1 <<= i17;
                            fArr = float1array(N, (float)22.24F);
                        } while (++i18 < 1);
        ...
        System.out.println("i i1 s1 = " + i + "," + i1 + "," + s1);
        System.out.println("i16 i17 i18 = " + i16 + "," + i17 + "," + i18);
        System.out.println("i19 i20 by3 = " + i19 + "," + i20 + "," + by3);
        System.out.println("b1 fArr = " + (b1 ? 1 : 0) + "," +
            Double.doubleToLongBits(checkSum(fArr)));

        System.out.println("Test.instanceCount Test.dFld Test.fFld = " + Test.instanceCount + "," +
            Double.doubleToLongBits(Test.dFld) + "," + Float.floatToIntBits(Test.fFld));
        System.out.println("Test.iFld Test.dArrFld Test.iArrFld = " + Test.iFld + "," +
