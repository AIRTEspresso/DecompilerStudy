...
public class Test {
    ...
    public static int iMeth(long l, int i2) {
        ...
        long meth_res = l + i2 + s1 + i16 + i17 + by2 + i18 + i19 + FuzzerUtils.checkSum(lArr) +
    ...
    public void mainTest(String[] strArr1) {
        ...
        FuzzerUtils.out.println("Test.bFld Test.iFld1 dFld = " + (Test.bFld ? 1 : 0) + "," + Test.iFld1 + "," +
