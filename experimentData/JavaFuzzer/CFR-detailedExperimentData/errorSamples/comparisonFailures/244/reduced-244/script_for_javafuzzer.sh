...
if ! grep -q 'Test.instanceCount Test.iFld Test.fFld = -141339,-24572,1190998016' output.txt; then
     echo 'failure'
     exit 1
fi
mkdir cfr
...
javac Test.java
timeout 15 java Test>>output.txt
if ! grep -q 'Test.instanceCount Test.iFld Test.fFld = -141339,-24562,1190998016' output.txt; then
     echo 'failure'
     exit 1
fi
echo 'success'
