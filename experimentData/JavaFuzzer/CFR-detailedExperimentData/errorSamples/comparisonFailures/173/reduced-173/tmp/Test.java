...
public class Test {
    ...
    public static void vMeth1() {
        ...
        vMeth1_check_sum += i4 + i5 + i6 + by + i7 + (b ? 1 : 0) + i8 + i9 + checkSum(sArr);
    }
    ...
    public void mainTest(String[] strArr1) {
        ...
        System.out.println("i d i13 = " + i + "," + Double.doubleToLongBits(d) + "," + i13);
        System.out.println("i14 i15 lArr = " + i14 + "," + i15 + "," + checkSum(lArr));
        System.out.println("dArr = " + Double.doubleToLongBits(checkSum(dArr)));

        System.out.println("Test.instanceCount byFld fFld = " + Test.instanceCount + "," + byFld + "," +
            Float.floatToIntBits(fFld));
        System.out.println("Test.iArrFld bArrFld = " + checkSum(Test.iArrFld) + "," +
            checkSum(bArrFld));
