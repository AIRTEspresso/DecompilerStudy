...
public class Test {
    ...
    public static void vMeth(int i2, int i3) {
        ...
        vMeth_check_sum += i2 + i3 + i4 + i5 + Double.doubleToLongBits(d1) + i6 + checkSum(iArr1);
    }
    ...
    public static float fMeth(long l, int i1, boolean b) {
        ...
        long meth_res = l + i1 + (b ? 1 : 0) + i7 + i8 + i9 + i10 + i11 + checkSum(iArr2) +
            Double.doubleToLongBits(checkSum(dArr)) + checkSum(byArr);
    ...
    public static int iMeth(byte by, float f, byte by1) {
        ...
        init(iArr, -13088);
        init(lArr, 7897112876680856121L);
        ...
        long meth_res = by + Float.floatToIntBits(f) + by1 + i + Double.doubleToLongBits(d) + (b1 ? 1 : 0) +
            Float.floatToIntBits(f1) + i12 + i13 + i14 + i15 + checkSum(iArr) + checkSum(lArr);
    ...
    public void mainTest(String[] strArr1) {
        ...
        System.out.println("i19 i20 l1 = " + i19 + "," + i20 + "," + l1);
        System.out.println("i21 d2 i22 = " + i21 + "," + Double.doubleToLongBits(d2) + "," + i22);
        System.out.println("d3 f2 = " + Double.doubleToLongBits(d3) + "," + Float.floatToIntBits(f2));
